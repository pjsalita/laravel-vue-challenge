...
7. **Check Status inclusion.** Check the status of the machine requirement does not cite what data to return, assumed container states and which drink can be brewed.
